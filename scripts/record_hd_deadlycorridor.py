...
def record(model_path, episodes, out_dir, deterministic=True, device="cuda"):
    ...
    for ep in range(1, episodes + 1):
        ...
        video_path = out_dir / f"deadlycorridor_ppo_episode_{ep:02d}_reward_{reward_sum:.0f}_steps_{step}.mp4"
    ...
    print("-" * 60)
    print("Best DeadlyCorridor episodes:")
...
def main():
    ...
    parser.add_argument("--model", type=str, default="models/deadlycorridor/ppo_deadlycorridor_500k.zip")
    parser.add_argument("--episodes", type=int, default=5)
    parser.add_argument("--out-dir", type=str, default="videos/deadlycorridor/ppo_500k")
